...
```http
POST https://api.github.com/repos/CptDolphin/gcp-vpc-sc/actions/workflows/intake.yml/dispatches
...
gh workflow run intake.yml -R CptDolphin/gcp-vpc-sc --ref main \
