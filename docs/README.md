...
| [9 — Karta wejścia](9-karta-wejscia.md) | **wchodzisz do cudzej organizacji**: gotowy do wysłania zestaw pytań o stan zastany, uprawnienia i cudze procesy — z konsekwencją każdego „nie" i mapą odpowiedź→knob. Wysyłasz go RAZEM z [`access-request.md`](access-request.md) |
