...
| `sa-vpcsc-apply` | jedyna tożsamość modyfikująca perimetr; tylko z `main` + environment z reviewerami |
...
| IAM Deny na `servicePerimeters.delete` / `policies.delete` | twardy zakaz ponad rolami |
...
gcloud iam roles describe vpcScPerimeterWriter --organization=179248107504 \
...
gcloud access-context-manager perimeters list --policy=829925107376 \
  --impersonate-service-account=sa-vpcsc-plan@rwlab-ai-vertex-46bc.iam.gserviceaccount.com

# konto plan NIE może nic zmienić (ma się nie udać — to jest ten test, który potwierdza podział)
gcloud access-context-manager perimeters update ai_core --policy=829925107376 \
  --add-resources=projects/102839858845 \
  --impersonate-service-account=sa-vpcsc-plan@rwlab-ai-vertex-46bc.iam.gserviceaccount.com

# Deny działa: apply też nie skasuje perimetru
gcloud access-context-manager perimeters delete ai_core --policy=829925107376 \
  --impersonate-service-account=sa-vpcsc-apply@rwlab-ai-vertex-46bc.iam.gserviceaccount.com
```
